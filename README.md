...
- For education, we have found that individuals with a lower education tend to be more likely to be prediabetic or diabetic. This could be due to the fact that they may not know which foods contain excessive sugar or maybe they do not care and eat uncontrollable amounts of sugar. 
- For age, typically the older groups from like 50 years old and onwards are more likely to be prediabetic or diabetic as compared to younger individuals. This makes sense since as individuals tend to get older, their metabolisms slow down which can cause more susceptibility to diabetes.
